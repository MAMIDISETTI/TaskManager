    ...
    <DashboardLayout activeMenu="Attendance">
      <div className="p-3 md:p-6 bg-gray-50 min-h-screen">
        ...
        <div className="mb-4 md:mb-6">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Attendance Overview</h1>
          <p className="text-sm md:text-base text-gray-600">Track and manage attendance for your assigned trainees</p>
        </div>
